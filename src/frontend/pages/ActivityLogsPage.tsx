...
const ActivityLogsPage = () => {
  ...
  const getActionBadgeColor = (action: string) => {
    const colors: Record<string, string> = {
      ...
      update_pcr_via_temp_login: 'bg-primary-100 text-primary-800 border-primary-200 dark:bg-primary-900/40 dark:text-primary-200 dark:border-primary-700/60',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1.1fr_1.1fr_0.6fr] gap-4">
            <Select
              ...
              options={[
                ...
                { value: 'login_via_temp_login', label: t('activityLogs.actions.login_via_temp_login') },
                { value: 'logout', label: t('activityLogs.actions.logout') },
                { value: 'logout_via_temp_login', label: t('activityLogs.actions.logout_via_temp_login') },
                ...
                { value: 'update_pcr_via_temp_login', label: t('activityLogs.actions.update_pcr_via_temp_login') },
                ...
                { value: 'update_temp_login_setting', label: t('activityLogs.actions.update_temp_login_setting') },
